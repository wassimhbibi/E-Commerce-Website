...
<header>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          ...
          <p class="text-muted">On this page there are a number of types xbox If you like one of our products, you only have to click to buy under each product.</p>
        </div>
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      <a href="produit2.php" class="navbar-brand d-flex align-items-center">
    ...
    <?php foreach ($produit as $p): ?>
        <div class="col">
          <div class="card shadow-sm">
           <title><?= $p->name1 ?></title><img src="<?= $p->picture1 ?>">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted"><?= $p->name1 ?></small>
                <small class="text-muted"><?= $p->price1 ?> TND</small>
              </div>
            </div>
          </div>
        </div>
