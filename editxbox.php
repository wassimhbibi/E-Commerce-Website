...
{
	if(isset($_POST['id1']) AND isset($_POST['pucture1']) AND isset($_POST['name1']) AND isset($_POST['price1']) AND isset($_POST['description1']))

{
	if(!empty($_POST['id1']) AND !empty($_POST['pucture1']) AND !empty($_POST['name1']) AND !empty($_POST['price1']) AND !empty($_POST['description1']))
     {
